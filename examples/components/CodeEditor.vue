<template>
  <div class="in-coder-panel">
    <textarea ref="textarea" v-model="code" style="height: 100% !important;" />
  </div>
</template>
...
import { reactive, defineComponent, toRefs, getCurrentInstance, onMounted, onBeforeUnmount, nextTick } from 'vue'
