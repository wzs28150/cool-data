<template>
  <div class="decoration-7 decoration" :ref="ref">
    <svg class="border-svg-container" :width="width" :height="height">
      ...
      <polyline
        ...
        :fill="mergedColor[2]"
        fill-opacity="0.6"
        class="decoration-7-center-left"
      />
      ...
      <polyline
        ...
        :fill="mergedColor[2]"
        fill-opacity="0.6"
        class="decoration-7-center-right"
      />
      ...
      <polyline
        ...
        :fill="mergedColor[3]"
        fill-opacity="0.6"
        class="decoration-7-center-left2"
      />
      ...
      <polyline
        ...
        :fill="mergedColor[4]"
        fill-opacity="0.6"
        class="decoration-7-center-left3"
      />
      ...
      <polyline
        ...
        :fill="mergedColor[2]"
        fill-opacity="0.6"
        class="decoration-7-center-left4"
      />
      ...
      <polyline
        ...
        :fill="mergedColor[3]"
        fill-opacity="0.6"
        class="decoration-7-center-right2"
      />
      ...
      <polyline
        ...
        :fill="mergedColor[4]"
        fill-opacity="0.6"
        class="decoration-7-center-right3"
      />
      ...
      <polyline
        ...
        :fill="mergedColor[2]"
        fill-opacity="0.6"
        class="decoration-7-center-right4"
      />
      ...
      <polyline
        ...
        `"
        :fill="`url(#linear-left-${id})`"
        class="decoration-7-left-line-down"
      />
      ...
      <polyline
        ...
        `"
        :fill="`url(#linear-right-${id})`"
        class="decoration-7-right-line-down"
      />
...
export default {
  ...
  data() {
    ...
    return {
      ref: 'decoration-7',
      filterId: `decoration-7-filterId-${id}`,
