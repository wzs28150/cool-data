<template>
  <div class="scroll-ranking-bar2"  :ref="thisData.ref">
    <div class="scroll-ranking-bar2-inner" :style="`height: ${height}px;`">
      <div
        class="row-item"
      ...
      >
        ...
        <div class="ranking-column" :style="`border-color:${item.color}`">
          <div class="inside-column" :style="`width: ${item.percent}%;background-color:${item.color}`">
            <div class="shine" />
          </div>
        </div>
      </div>
